        ...
        <div class="top">
            ...
            <div class="cta">
                ...
                <div class="dropdown-container">
                    ...
                    <div class="dropdown-menu custom-date-menu">
                        <div class="date-group">
                            <label>Từ ngày</label>
                            <input type="date" class="custom-date-input" id="filter-start-date">
                        </div>
                        <div class="date-group">
                            <label>Đến ngày</label>
                            <input type="date" class="custom-date-input" id="filter-end-date">
                        </div>
                        <button class="btn-filter-date">Áp dụng</button>
                    </div>
                </div>

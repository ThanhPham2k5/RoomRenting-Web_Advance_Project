<?php
    ...
    $canEdit = checkPermission('personalInfo.update') ?? false;
?>
...
<div class="setting-page">
    ...
    <div class="setting-page-main">
        ...
        <form class="right-info" id="panel-info" style="display: flex; flex-direction: column;" onsubmit="handleSaveSettings(event)">
            ...
            <div class="item">
                <p>Số điện thoại</p>
                <input type="text" name="phone_number" value="<?php echo htmlspecialchars($info['phoneNumber'] ?? ''); ?>">
            </div>
            <div class="item">
                <p>Email</p>
            ...
            <div class="item">
                <p>Địa chỉ</p>
                <input type="text" name="house_number" value="<?php echo htmlspecialchars($info['houseNumber'] ?? ''); ?>" placeholder="Số nhà, Tên đường" style="margin-bottom: 10px;">
            ...
            <div class="item">
                <p>Ngày sinh</p>
                <input type="date" name="date_of_birth" value="<?php echo htmlspecialchars($info['dateOfBirth'] ?? ''); ?>">
            </div>
            <?php if($canEdit){ ?> 

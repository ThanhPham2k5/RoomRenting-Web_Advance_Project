...
<div class="pagination-component">
    <div class="main-content">
        ...
        <?php if ($currentPage > 1): ?>
            <a href="<?php echo $baseUrl . '&p=1' . $filterQuery; ?>" style="color: inherit; display: flex; align-items: center;">
            ...
            <a href="<?php echo $baseUrl . '&p=' . ($currentPage - 1) . $filterQuery; ?>" style="color: inherit; display: flex; align-items: center;">
        ...
        <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
            <a href="<?php echo $baseUrl . '&p=' . $i . $filterQuery; ?>" 
        ...
        <?php if ($currentPage < $lastPage): ?>
            ...
            <a href="<?php echo $baseUrl . '&p=' . $lastPage . $filterQuery; ?>" style="color: inherit; display: flex; align-items: center;">
                <svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">

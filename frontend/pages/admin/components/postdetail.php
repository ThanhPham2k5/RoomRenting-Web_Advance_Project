<div class="post-detail-component-overlay">
    <div class="post-detail-component-content">
        <div class="post-img">
            <div class="main-image-wrapper">
                <img src="../../assets/admin/images/post_img.png" alt="Ảnh chính">
        ...
        <div class="post-info">
            <p>ID bài đăng: 123</p>
            <p>Phòng giá 5 tỷ/ tháng, đường Trương Phước Phan, phường Bình Trị Đông, quận Bình Tân</p>
            <div class="location">
                ...
                <p>Phường Bình Trị Đông, Tp Hồ Chí Minh</p>
            </div>
            <div class="price">
                <p class="main">3.000.000 VNĐ/ tháng</p>
                <p class="area">57.5 m²</p>
            </div>
            <p>Số tiền cọc: 3 tỷ</p>
            <p>Mô tả chi tiết</p>
            <p class="detail">Địa chỉ: Đường Tân Nhất 13 , Phường Tân Thới Nhất , Quận 12  
            ...
            <p>ID người đăng bài: 123</p>
            <p>ID nhân viên duyệt bài: 123</p>

        ...
        <div class="cta">
            ...
            ?>
                ...
                <button class="filter">
                    ...
                    <path d="M17 2.6C17 2.04 17 1.76 16.89 1.546... (giữ nguyên SVG của bạn)..." stroke="#1F2937" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p>Bộ lọc</p>
                    <svg width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.45 0.850013L4.825 4.47501... (giữ nguyên SVG của bạn)..." fill="#1F2937"/>
                    </svg>
                </button>
            <?php 
            } 
            ?>
            <button class="search-btn">Tìm phòng</button>
        </div>
    </div>
</div>
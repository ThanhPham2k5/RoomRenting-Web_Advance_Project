<?php 
    $titleData = ['titleContent' => "Khuyến mãi", 'group' => false, 'insert' => true, 'edit' => true, 'delete' => true, 'handle' => false];
    $tableHeader = ['Id', 'Tên khuyến mãi', 'Giảm giá', 'Tình trạng', 'Chi tiết'];
    $type = ['type' => "1"];
    ob_start(); 
    ?>
        <tr>
    ...
    $tableData = ['tableTitle' =>"Thông tin khuyến mãi", 'tableHeader' => $tableHeader, 'time' => false, 'status' => true, 'tbodyHtml' => $tbodyHtml];
?>
